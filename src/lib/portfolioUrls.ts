...
export const TAS_3D2N_COVER_URL =
  `${PORTFOLIO_PUBLIC_BASE}/Tasmania/Launceston/596811714_1428639069261190_2753284779604496226_n.jpg`;

/** Card / sheet cover — portfolio/Tasmania/Launceston */
export const TAS_LH_4D3N_COVER_URL =
  `${PORTFOLIO_PUBLIC_BASE}/Tasmania/Launceston/596371362_1428639202594510_8709278754225773992_n.jpg`;
