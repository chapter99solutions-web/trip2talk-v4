...
export const WAIVER_TEXT = {
  EN: {
    ...
    cancellation:
      'I accept trip tiers (Standard 4–6 guests, Private 2–3 guests Guaranteed Departure) and the cancellation policy: owner cancellation <45 days before departure — 100% refund; client cancellation >90d 10% fee, 61–90d 30%, 31–60d 50%, ≤30d no refund.',
  },
  TH: {
    ...
    cancellation:
      'ข้าพเจ้ายอมรับระดับทริป (Standard 4–6 คน, Private 2–3 คน Guaranteed Departure) และนโยบายยกเลิก: ยกเลิกโดยพี่แสน <45 วันก่อนออกทริป คืน 100%; ลูกค้ายกเลิก >90 วัน หัก 10%, 61–90 หัก 30%, 31–60 หัก 50%, ≤30 วัน ไม่คืน',
  },
} as const;
