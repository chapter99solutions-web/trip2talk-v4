...
const REVIEWS: Testimonial[] = [
  ...
  },
  {
    ...
    stars: 5,
    quote:
      'เปิดโลกมากครับ! ทริปนี้ไม่ใช่ทริปชะโงกทั่วไป แต่คือ Photo Trip ของจริง พี่แสนพาไปดักรอแสงเย็นช่วง Golden Hour และตื่นมาเก็บแสงเช้า Blue Hour ฟินสุดคือคืนที่สองฟ้าเปิด ได้ถ่ายภาพคู่กับทางช้างเผือก (Milky Way) สดๆ เหนือทะเลสาบสีชมพู อลังการจนลืมหายใจ ขอบคุณทีมงาน Trip2Talk และ Chapter 99 สำหรับความทรงจำและมิตรภาพดีๆ ในห้องพัก Dorm Setup สนุกเหมือนไปเที่ยวกับกลุ่มเพื่อนสนิทเลยครับ',
  },
  {
    name: 'คุณเคท',
